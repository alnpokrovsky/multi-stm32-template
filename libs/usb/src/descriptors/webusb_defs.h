...
#ifndef __LIB_USB_DESCRIPTORS_WEBUSB_DEFS_H__
#define __LIB_USB_DESCRIPTORS_WEBUSB_DEFS_H__
...
} __attribute__((packed)) webusb_platform_descriptor;
...
#define WEBUSB_PLATFORM_DESCRIPTOR_SIZE sizeof(webusb_platform_descriptor)
...
typedef struct {
	...
	uint8_t bScheme;
	char URL[];
} __attribute__((packed)) webusb_url_descriptor;

#define WEBUSB_DT_URL_DESCRIPTOR_SIZE 3

#endif //  __LIB_USB_DESCRIPTORS_WEBUSB_DEFS_H__