...
#if LV_TICK_CUSTOM == 1
#define LV_TICK_CUSTOM_INCLUDE  "cmsis_os2.h"       /*Header for the sys time function*/
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (osKernelGetTickCount())     /*Expression evaluating to current systime in ms*/
